...
void Internal::initPBI() {
	...
	EGG_ASSERT(NT_SUCCESS(winapi::NtQueryInformationProcess(NtCurrentProcess, ProcessBasicInformation, &pbi, sizeof(pbi), nullptr)), "Failed to query process information");
	this->pbi = pbi;
